...
int select = 8;
int state;
int led = G15; //pin for RELAY SWITCH
int state1;
int state2;


#define  MOT1_DIR   G0       // Motor 1 direction
#define  MOT1_STP   G4       // Motor 1 step
#define  MOT2_DIR   G14       // Motor 2 direction
#define  MOT2_STP   G27       // Motor 2 step
